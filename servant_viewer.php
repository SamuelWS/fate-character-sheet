...
$queries = array("name", "align", "str", "end", "agi", "man", "lck", "mrs", "class", "off", "quali", "place", "pfp", "war", "player", "np", "type", "anti", "quote");
    ...
    <div class = 'charsheet'>
      <div class = 'column'>
        ...
        <div class ='row border'>
          ...
          <h5 class ='class-attribute attr-row' style = 'clear: both; float: left'>Qualified Classes:</h5>
        ...
        <div class = 'row border bottom'>
          <h3 class = 'title'>Noble Phantasm</h3>
          <h3>$np</h3>
